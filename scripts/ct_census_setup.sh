...
CLS_GIT=${CLS_GIT:-https://github.com/Robertgao0818/solar_cls.git}  # adjust if private/different
HF_DETECTOR_REPO=${HF_DETECTOR_REPO:?export HF_DETECTOR_REPO=<your-hf-repo-id> (unified_A)}
